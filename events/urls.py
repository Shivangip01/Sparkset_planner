...
from . import views
from .views import vendor_signup, vendor_dashboard
...
urlpatterns = [
    ...
    path('payment/<int:booking_id>/', views.process_payment, name='process_payment'),  # URL for payment processing
    path('booking_confirmation/<int:booking_id>/', views.booking_confirmation, name='booking_confirmation'),  # URL for booking confirmation
    path('vendor/signup/', views.vendor_signup, name='vendor_signup'),  # vendor signup
    path('vendor/login/', views.vendor_login, name='vendor_login'),  # vendor login
    path('vendor/dashboard/', views.vendor_dashboard, name='vendor_dashboard'),  # Add this line
    path('vendor/add_service/', views.add_service, name='add_service'),
    path('vendor/service/delete/<int:service_id>/', views.delete_service, name='delete_service'),  ###To delete service from vendor's end##
    ...
    path('about/', views.about_us, name='about_us'),  # New URL path for About Us page
    path('user/dashboard/', views.user_dashboard, name='user_dashboard'),  # New path for user dashboard
    #path('services/', views.services, name='services'),  # New path for Services page
    path('feedback/', views.feedback_view, name='feedback'),  # Updated to use feedback_view
